...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
	...
	var e = Math.PI / 180,
		...
		m = function(e) {
			...
			for (t = 0; A > t; t++) if (v = s, isNaN(b[t]) ? (s = b[t].toUpperCase(), h = s !== b[t]) : t--, o = +b[t + 1], i = +b[t + 2], h && (o += C, i += S), 0 === t && (f = o, g = i), "M" === s) l && l.length < 8 && (M.length -= 1, y = 0), C = f = o, S = g = i, l = [o, i], x += y, y = 2, M.push(l), t += 2, s = "L";
		...
		T = function(e, t, r, n) {
			...
			if (p[0]) {
				...
				if (g) for (0 > g && (g = -g), u[0].length > p[0].length && v(p[0], (u[0].length - p[0].length) / 6 | 0), C = p.length; g > d;) s = u[C].size || S(u[C]), a = _(p, u[C].centerX, u[C].centerY), s = a[0], h = a[1], p[C++] = [s, h, s, h, s, h, s, h], p.totalPoints += 8, d++;
		...
		F = _gsScope._gsDefine.plugin({
			...
			init: function(e, t, r, n) {
				...
				return "function" != typeof e.setAttribute ? !1 : u ? ("function" == typeof t && (t = t(n, e)), o = e.nodeName.toUpperCase(), d = "POLYLINE" === o || "POLYGON" === o, "PATH" === o || d ? (a = "PATH" === o ? "d" : "points", ("string" == typeof t || t.getBBox || t[0]) && (t = {
					shape: t
				}), p = O(t.shape || t.d || t.points || "", "d" === a, e), d && i.test(p) ? (c("WARNING: a <" + o + "> cannot accept path data. " + R), !1) : (p && (this._target = e, e.getAttributeNS(null, "data-original") || e.setAttributeNS(null, "data-original", e.getAttribute(a)), s = this._addTween(e, "setAttribute", e.getAttribute(a) + "", p + "", "morphSVG", !1, a, "object" == typeof t.precompile ?
				function(e) {
					console.log(e)
					e[0] = t.precompile[0], e[1] = t.precompile[1]
				} : "d" === a ? L(t.shapeIndex, t.map || F.defaultMap, t.precompile) : B(t.shapeIndex)), s && (this._overwriteProps.push("morphSVG"), s.end = p, s.endProp = a)), u)) : (c("WARNING: cannot morph a <" + o + "> SVG element. " + R), !1)) : ( !1)
			},
			set: function(e) {
				var t;
